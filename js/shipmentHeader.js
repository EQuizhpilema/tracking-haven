...
// Generate HTML for a shipment header
function generateShipmentHeaderHTML(shipment) {
    ...
    <div class="mb-3">
      <div class="d-flex justify-content-between align-items-start pe-4">
        ...
        <div class="d-flex flex-column align-items-end">
          <span class="fs-5 fw-semibold text-dark">${statusText}</span>
          <div class="mt-1">
            ${isDelivered 
...
// Initialize a shipment header component in a container
function initShipmentHeader(shipment, containerId) {
  const container = document.getElementById(containerId);
  if (container) {
    container.innerHTML = generateShipmentHeaderHTML(shipment);
  }
}
